...
namespace Ecommerce.Controllers
{
    public class OrdersController : Controller
    {
        ...
        {
            var myDBContext = _context.Orders.Include(o => o.Staff).Include(o => o.Voucher_User);
        ...
        public async Task<IActionResult> Create([Bind("id_order,name,order_time,description,price,status,id_staff,id_voucher,id_user")] Order order)
        {
            ...
            ViewData["id_staff"] = new SelectList(_context.Staffs, "id_staff", "email", order.id_staff);
